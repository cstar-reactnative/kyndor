    ...
    return (
      <View style={styles.modalcontainer1}>
        ...
        <View style={styles.modaltextsection}>
          ...
          <Text style={{fontFamily: "System",paddingTop: 12, paddingBottom: 12, paddingLeft: 15, paddingRight: 15, color: "#bcbbc1"}}>Private chat groups are visible only to parents that you have invited. Public chat groups are visible to all parents in this business group.</Text>
        </View>
