...
export default class SchoolsTags extends React.Component {
  constructor(props){
    super(props);
    this.state={
      checked1: false,
  ...
  render(){
    return(
      <ScrollView style={{flex: 1}} >
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, paddingRight: 15, paddingLeft: 15 }} >
