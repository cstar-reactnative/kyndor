...
class CardCustomChatGroupList extends Component {
  render() {
    const { index, handleCustomSelect, array_Custom } = this.props;
                ...
                <View style={[ container00 , {justifyContent: 'center', alignItems:'center'}]}>
                  {
                    ...
                    <Icon
                      ...
                      name='check'
                      style={{color: '#6d3ccb'}}
                      onPress={() => handleCustomSelect( index,this.props.items)}
                    />
                    :
                    <Icon
                      type='EvilIcons'
...
export default CardCustomChatGroupList;
