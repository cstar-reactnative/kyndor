        ...
        return(
            <TouchableOpacity style={{backgroundColor: '#ecedf3', paddingTop: 20, paddingBottom: 20, paddingLeft: 15, paddingRight: 15}} >
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}} >
                    <Text style={{fontSize: 16, fontWeight: 'bold', color: '#212121'}} >Dl Class Ranger</Text>
                    <View style={{flexDirection: 'row'}} >
                        <Text style={{fontSize: 15, marginRight: 10}} >Yesterday, 11:24</Text>
                        <View style={{backgroundColor: '#484b89', paddingLeft: 6, paddingRight: 6, borderRadius: 3}} >
                            <Text style={{fontSize: 14, color: '#fff'}} >2</Text>
                        </View>
                    </View>
                </View>
                <Text style={{fontSize: 15}} >How can we do that? It's irrational and not possible...</Text>
            </TouchableOpacity>
        );
    }
}
